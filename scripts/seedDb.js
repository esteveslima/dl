const Profile = require('../src/models/entities/profile.model');
const Contract = require('../src/models/entities/contract.model');
const Job = require('../src/models/entities/job.model');
